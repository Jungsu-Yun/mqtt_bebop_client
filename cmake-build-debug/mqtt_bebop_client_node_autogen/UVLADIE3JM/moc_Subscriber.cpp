...
QT_MOC_LITERAL(4, 28, 11), // "sendBattery"
QT_MOC_LITERAL(5, 40, 7) // "battery"

    },
    "Subscriber\0sendFrame\0\0frame\0sendBattery\0"
    "battery"
};
...
void Subscriber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendBattery((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Subscriber::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subscriber::sendFrame)) {
                *result = 0;
            }
        }
        {
            typedef void (Subscriber::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subscriber::sendBattery)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Subscriber::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Subscriber.data,
...
// SIGNAL 0
void Subscriber::sendFrame(QImage _t1)
{
...
// SIGNAL 1
void Subscriber::sendBattery(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
